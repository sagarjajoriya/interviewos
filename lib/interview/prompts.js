...
Interview focus: ${type.guidance}${focusLine}
...
Rules: scores are integers 1-5. Base everything on the transcript only. If the interview was too short to judge a dimension, score conservatively and note it in concerns. Output raw JSON only, no prose, no code fences.`;
